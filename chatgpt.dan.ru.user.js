...
// @updateURL       https://github.com/RIllEX0/ChatGPT_Bypass_Limit/raw/main/chatgpt.dan.ru.user.js
// @downloadURL     https://github.com/RIllEX0/ChatGPT_Bypass_Limit/raw/main/chatgpt.dan.ru.user.js
// @version         3.6.5
// @description     Удаление фильтров и обход правил OpenAI для ChatGPT.
// @author          x
...
(async function () {
  ...
  // ---------- Init values ----------
  const mdFileUrl =
    "https://raw.githubusercontent.com/RIllEX0/ChatGPT_Bypass_Limit/main/README_RU.md";
  const version =
    "https://raw.githubusercontent.com/RIllEX0/ChatGPT_Bypass_Limit/main/version.json";
  const isMobile =
  ...
  // The dragging button
  const draggingButton = createEl("button", {
    id: "dan-drag-switch",
